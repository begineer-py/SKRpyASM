...
from apps.ai_assistant.api.message_events_stream_views import stream_thread_message_events
...
urlpatterns = [
    ...
    path(
        "threads/<int:thread_id>/messages/events/stream/",
        stream_thread_message_events,
        name="stream_thread_message_events",
    ),
    path(
