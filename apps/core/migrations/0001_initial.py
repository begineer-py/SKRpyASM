# Generated by Django 5.2.4 on 2026-05-14 10:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="向量名稱，如 'Reflected XSS on /api/user'",
                        max_length=500,
                    ),
                ),
                (
                ...
                (
                    "evidence",
                    models.TextField(
                        blank=True, help_text="可利用性的具體證據/Payload", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        help_text="技能摘要描述。用於 RAG 檢索，讓 AI 判斷是否需要呼叫此技能。"
                    ),
                ),
                (
                    "instructions",
                    models.TextField(
                        help_text="等同於 SKILL.md，包含該如何正確使用與傳參的指南。"
                    ),
                ),
                (
                    "script_content",
                    models.TextField(
                        blank=True,
                        help_text="實際執行的工具源碼 (例如 Python 或 Bash 腳本)。",
                        null=True,
                    ),
                ),
                (
                    "language",
                    models.CharField(
                        default="python", help_text="腳本語言", max_length=20
                    ),
                ),
                (
                    "tags",
                    models.JSONField(
                        default=list,
                        help_text="標籤(如 'django', 'csrf', 'python') 用於分類與過濾",
                    ),
                ),
                (
                    "usage_count",
                    models.IntegerField(
                        default=0,
                        help_text="被使用的次數，幫助排序高信賴度的且被重複驗證過的技能",
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.TextField(blank=True, help_text="目前目標的筆記", null=True),
                ),
                (
                    "techs",
                    models.JSONField(blank=True, help_text="偵測到的技術棧", null=True),
                ),
                (
                    "knowledge",
                    models.JSONField(
                        blank=True, help_text="當前對目標的認知快照", null=True
                    ),
                ),
                (
                    "plan",
                ...
                (
                    "risk_score",
                    models.PositiveSmallIntegerField(
                        default=0, help_text="綜合風險評分 (0-100)"
                    ),
                ),
                (
                    "thread_id",
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="建立此任務的上層節點/Caller Thread ID (for async completion callback)",
                        null=True,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="overviews", to="core.ip"
                    ),
                ),
                (
                    "seed",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ip",
                    models.ManyToManyField(
                        blank=True, related_name="steps", to="core.ip"
                    ),
                ),
                (
                    "overview",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_url",
                    models.URLField(blank=True, help_text="來源網址", null=True),
                ),
        ...
        migrations.AddField(
            ...
            name="subdomain",
            field=models.ManyToManyField(
                blank=True, related_name="steps", to="core.subdomain"
            ),
        ),
        migrations.AddField(
            model_name="overview",
            name="subdomains",
            field=models.ManyToManyField(
                blank=True, related_name="overviews", to="core.subdomain"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name="url_result",
            field=models.ManyToManyField(
                blank=True, related_name="steps", to="core.urlresult"
            ),
        ),
        migrations.AddField(
            model_name="overview",
            name="url_results",
            field=models.ManyToManyField(
                blank=True, related_name="overviews", to="core.urlresult"
            ),
        ),
        migrations.CreateModel(
            name="NucleiScan",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_converted",
                    models.BooleanField(
                        default=False, help_text="是否已轉換為 Overview"
                    ),
                ),
                (
                    "raw_response",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "execution_time_ms",
                    models.IntegerField(
                        blank=True, help_text="執行耗時（毫秒）", null=True
                    ),
                ),
                (
                    "created_at",
                    models.DateTimeField(
                        auto_now_add=True, db_index=True, help_text="日誌建立時間"
                    ),
                ),
                (
                    "sequence",
                    models.PositiveIntegerField(
                        db_index=True, default=0, help_text="此 Step 內的日誌序列號"
                    ),
                ),
                (
                    "step",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="core_steplo_step_id_ce1943_idx",
                    ),
                    models.Index(
                        fields=["step", "level"], name="core_steplo_step_id_0f8bfb_idx"
                    ),
                    models.Index(
                        fields=["step", "tag"], name="core_steplo_step_id_72d638_idx"
                    ),
                ],
            },
        ),
