# Generated by Django 5.2.4 on 2026-03-13 15:37
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.TextField(
                        blank=True, help_text="目標現狀的一句話總結", null=True
                    ),
                ),
                (
                    "techs",
                ...
                (
                    "plan",
                    models.TextField(
                        blank=True, help_text="AI 擬定的下一步計畫", null=True
                    ),
                ),
                (
                    "status",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="triggered_ip_analyses",
                        to="core.step",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="subdomain_analyses",
                        to="core.overview",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="triggered_subdomain_analyses",
                        to="core.step",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="triggered_url_analyses",
                        to="core.step",
                    ),
                ),
                (
