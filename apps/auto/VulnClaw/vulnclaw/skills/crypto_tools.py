"""Crypto Toolkit — encoding/decoding, encryption/decryption utilities for web security.

Provides encoding/decoding and crypto operations commonly needed
during web security testing and CTF challenges.
